...
#Get input from user and place in the text field
i=0
...
Button(root, text="dlt", command= lambda :undo()).grid(row=2,column=5)
Button(root, text="^3", command= lambda :get_operation("**2")).grid(row=3,column=5)
